...
# Enter coordinates all two deck ships - [][]
            ...
            while i <= max_ships[1]:
                ...
                if isinstance(ship_coo, list) and isinstance(ship_coo2, list):
                    if check_busy(ship_coo, player1) == 0 or\
                            check_busy(ship_coo2, player1) == 0:  # Check cell for busy
...
# Enter coordinates all three deck ships - [][][]
            ...
            n = 3.0
            while i <= max_ships[2]:
                print('\n', player1.name, ', enter coordinates three deck ships (3 cell))')
                ...
                if isinstance(ship_coo, list) and isinstance(ship_coo2, list) and isinstance(ship_coo3, list):
                    if check_busy(ship_coo, player1) == 0 or\
                            check_busy(ship_coo2, player1) == 0 or\
                            check_busy(ship_coo3, player1) == 0:  # Check cell for busy
                        print('Cell is busy! Enter coo again.')
                        print('\n', end='')
                        num_x = 1
                        for row in Storage.field_players[player1.queue]:  # Show map player1 with ship/s
                        ...
                        if ship_connection_check([ship_coo, ship_coo2, ship_coo3]) == 1:
                            ...
                            # Write map with two ships to player1 storage
                            Storage.field_players[player1.queue][ship_coo[0]][ship_coo[1]] = '[3]'
                            Storage.field_players[player1.queue][ship_coo2[0]][ship_coo2[1]] = '[3]'
                            Storage.field_players[player1.queue][ship_coo3[0]][ship_coo3[1]] = '[3]'
...
# Enter coordinates all four deck ships - [][][][]
            ...
            n = 4.0
            while i <= max_ships[3]:
                print('\n', player1.name, ', enter coordinates four deck ships (3 cell))')
                ...
                if isinstance(ship_coo, list) and\
                    ...
                    if check_busy(ship_coo, player1) == 0 or\
                            check_busy(ship_coo2, player1) == 0 or\
                            check_busy(ship_coo3, player1) == 0 or \
                            check_busy(ship_coo4, player1) == 0:  # Check cell for busy:  # Check cell for busy
                        print('Cell is busy! Enter coo again.')
                        print('\n', end='')
                        num_x = 1
                        for row in Storage.field_players[player1.queue]:  # Show map player1 with ship/s
                        ...
                        if ship_connection_check([ship_coo, ship_coo2, ship_coo3, ship_coo4]) == 1:
                            ...
                            # Write map with two ships to player1 storage
                            Storage.field_players[player1.queue][ship_coo[0]][ship_coo[1]] = '[4]'
                            Storage.field_players[player1.queue][ship_coo2[0]][ship_coo2[1]] = '[4]'
                            Storage.field_players[player1.queue][ship_coo3[0]][ship_coo3[1]] = '[4]'
                            Storage.field_players[player1.queue][ship_coo4[0]][ship_coo3[1]] = '[4]'
                            # Add ships in storage
